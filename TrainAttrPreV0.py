...
from AttrPreModelRes34_256V0 import *
...
def add(x):
    with open('TrainAttrPreResNet34256V0Log',"a+") as outfile:
        outfile.write(x + "\n")
...
for epoch in range(start_epoch, end_epoch + 1):
    ...
    checkpoint_name = os.path.join('AttrPreResNet34Det256V0_MSEloss.pth.tar')
    save_checkpoint({
        'epoch': epoch + 1,
