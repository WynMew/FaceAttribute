...
def main():
    ...
    dataset = 'celebA'
    Path = '/home/SSD1/celebA/img/'
    Image_list = '/home/SSD1/celebA/Anno/list_attr_celeba.txt'
    Save_root = '/home/SSD1/celebA/det'
    Save_list = '/home/SSD1/celebA/celebAMTCNN'

    f = open(Save_list, 'wt')

    with open("/home/SSD1/celebA/Anno/list_attr_celeba.txt") as lmfile:
        lineNum = sum(1 for _ in lmfile)

    it = iter(range(3, lineNum))
    for m in it:
        line = lc.getline("/home/SSD1/celebA/Anno/list_attr_celeba.txt", m)
        Name = line.rstrip('\n')
        file = Name.split(" ")
        Image_Path = Path + file[0]
        Save_Path = Save_root + "/" + file[0]
